...
:Out "C:\Users\Purvi\Desktop\Scripts\Library_SQL_Project_Letter.txt"
...
declare @message1 as varchar(1000), @member_first_name as varchar(30), @member_last_name as varchar(30), @item_per_member as int;
declare @tempchar100 as varchar(100), @file_path as varchar(100), @curr_member_id as int;

set @message1 = '';
set @item_per_member = 0;
set @curr_member_id = 0;
set @file_path = 'C:\Users\Purvi\Desktop\Scripts\';
...
begin
	...
	begin
		...
		begin
			...
			if (@message1 <> '')
			begin
				set @message1 += CHAR(13) + CHAR(10) + 'Yours sincerely, ' + CHAR(13) + CHAR(10) + 'Librarian, ' + CHAR(13) + CHAR(10);
				select @tempchar100 = Library_Name from Library where Library_ID = (select Media_Library_ID from Media where Media_ID = @mediaid);
				set @message1 += @tempchar100 + ', ' + CHAR(13) + CHAR(10);
				...
				set @file_path = 'C:\Users\Purvi\Desktop\Scripts\' + CAST(@memid as varchar(12)) + '.txt';
				print(@message1);
...
*/
			...
			set @message1 = 'Dear ' + @member_first_name + ' ' + @member_last_name + ', ' + CHAR(13) + CHAR(10);
				...
				set @message1 += @tempchar100 + ' ' + CHAR(13) + CHAR(10) + CHAR(13) + CHAR(10);
			set @message1 += 'Following items from our library are due. ';
			set @message1 += 'Please renew or return them to the Library soon. Thank you.' + CHAR(13) + CHAR(10);
		end;
		...
		set @message1 += CAST(@item_per_member as varchar(5)) + ' ' + CAST(@mediaid as varchar(8)) + ' ' + @tempchar100 + ' ' + CAST(@chk_out_due_date as varchar(10)) + ' ' + CHAR(13) + CHAR(10);;
	end;
	fetch next from media_notify_dues_loop into @memid, @chk_out_due_date, @mediaid, @mem_dues_updated;
end;
